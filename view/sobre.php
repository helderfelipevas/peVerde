	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content  animate-box fh5co-border-bottom" data-animate-effect="fadeInLeft">
				<h2 class="fh5co-heading" >Desenvolvedores</span></h2>

				<div class="row">
					<div class="col-md-6 fh5co-staff">
						<img src="images/equipe/helder.jpg" class="img-responsive">
						<h3>Helder Felipe</h3>
						<h4>Programador</h4>
						<p>Formado em Analise e Desenvolvimento de Sistema pela Faculdade de Tecnologia de Praia Grande, atua como programador de sistemas web.</p>
						<ul class="fh5co-social">
							<li><a href="https://br.linkedin.com/in/helderfelipevas"><i class="icon-linkedin-square"></i></a></li>
						</ul>
					</div>
					<div class="col-md-6 fh5co-staff">
                                            <img src="images/equipe/flavia.jpg" class="img-responsive">
						<h3>Flavia Silva</h3>
						<h4>Programadora</h4>
						<p>Desenvolvedora Web e Desktop em PHP e VB, Conhecimento de SQL - MYSQL, metodologia Scrum e PMBok. Formada na FATEC Praia Grande.</p>
						<ul class="fh5co-social">
							<li><a href="https://br.linkedin.com/in/flaviaass65"><i class="icon-linkedin-square"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
